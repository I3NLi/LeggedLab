...
class MagicBotZ1RewardCfg(RewardCfg):
    ...
    track_lin_vel_y_exp = RewTerm(func=mdp.track_lin_vel_y_yaw_frame_exp, weight=0.0, params={"std": 0.35})
    forward_speed_progress = RewTerm(
        func=mdp.forward_speed_progress,
        weight=0.0,
        params={"min_command_x": 3.0, "max_ratio": 1.0},
    )
    lateral_speed_progress = RewTerm(
        func=mdp.lateral_speed_progress,
        weight=0.0,
        params={"min_command_abs": 0.15, "max_ratio": 1.0},
    )
    track_ang_vel_z_exp = RewTerm(func=mdp.track_ang_vel_z_world_exp, weight=1.0, params={"std": 0.5})
    yaw_rate_progress = RewTerm(
        func=mdp.yaw_rate_progress,
        weight=0.0,
        params={"min_command_abs": 0.25, "max_ratio": 1.0},
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2NAgilityMixEnvCfg(MagicBotZ1FlatSprintAMPStage2LStabilityAnchorEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (3.35, 4.50)
        self.commands.ranges.lin_vel_y = (-0.35, 0.35)
        self.commands.ranges.ang_vel_z = (-0.65, 0.65)
        self.reference_motion.min_command_speed = 3.35
        self.reference_motion.max_reference_speed = 5.2
        self.reference_motion.speed_match_tolerance = 0.85
        self.reward.track_lin_vel_xy_exp.weight = 1.95
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.95
        self.reward.track_lin_vel_y_exp.weight = 0.55
        self.reward.track_lin_vel_y_exp.params["std"] = 0.35
        self.reward.track_ang_vel_z_exp.weight = 1.85
        self.reward.track_ang_vel_z_exp.params["std"] = 0.50
        self.reward.forward_speed_progress.weight = 0.20
        self.reward.forward_speed_progress.params["min_command_x"] = 3.35
        self.reward.head_shoulder_contact_termination_penalty.weight = -260.0
        self.reward.ang_vel_xy_l2.weight = -0.08
        self.reward.body_orientation_l2.weight = -2.5
        self.reward.flat_orientation_l2.weight = -1.2
        self.reward.action_rate_l2.weight = -8.0e-3
...
@configclass
class MagicBotZ1FlatSprintAMPStage2PMixedCommandEnvCfg(MagicBotZ1FlatSprintAMPStage2LStabilityAnchorEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (3.35, 4.55)
        self.commands.ranges.lin_vel_y = (-0.35, 0.35)
        self.commands.ranges.ang_vel_z = (-0.65, 0.65)
        self.commands.straight_command_prob = 0.45
        self.reference_motion.min_command_speed = 3.35
        self.reference_motion.max_reference_speed = 5.2
        self.reference_motion.speed_match_tolerance = 0.85
        self.reward.track_lin_vel_xy_exp.weight = 1.95
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.95
        self.reward.track_lin_vel_y_exp.weight = 0.45
        self.reward.track_lin_vel_y_exp.params["std"] = 0.35
        self.reward.track_ang_vel_z_exp.weight = 1.75
        self.reward.track_ang_vel_z_exp.params["std"] = 0.50
        self.reward.forward_speed_progress.weight = 0.24
        self.reward.forward_speed_progress.params["min_command_x"] = 3.35
        self.reward.head_shoulder_contact_termination_penalty.weight = -260.0
...
@configclass
class MagicBotZ1FlatSprintAMPStage2QYawFocusEnvCfg(MagicBotZ1FlatSprintAMPStage2PMixedCommandEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_y = (-0.30, 0.30)
        self.commands.ranges.ang_vel_z = (-0.75, 0.75)
        self.commands.straight_command_prob = 0.40
        self.commands.yaw_only_command_prob = 0.35
        self.reference_motion.speed_match_tolerance = 0.90
        self.reward.track_lin_vel_y_exp.weight = 0.35
        self.reward.track_lin_vel_y_exp.params["std"] = 0.40
        self.reward.track_ang_vel_z_exp.weight = 2.10
        self.reward.track_ang_vel_z_exp.params["std"] = 0.45
        self.reward.head_shoulder_contact_termination_penalty.weight = -280.0


@configclass
class MagicBotZ1FlatSprintAMPStage2RYawAuthorityEnvCfg(MagicBotZ1FlatSprintAMPStage2QYawFocusEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_y = (-0.25, 0.25)
        self.commands.ranges.ang_vel_z = (-0.85, 0.85)
        self.commands.straight_command_prob = 0.35
        self.commands.yaw_only_command_prob = 0.45
        self.reference_motion.speed_match_tolerance = 0.95
        self.reward.track_lin_vel_y_exp.weight = 0.25
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        self.reward.track_ang_vel_z_exp.weight = 2.35
        self.reward.track_ang_vel_z_exp.params["std"] = 0.38
        self.reward.yaw_rate_progress.weight = 0.45
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.25
        self.reward.forward_speed_progress.weight = 0.22
        self.reward.head_shoulder_contact_termination_penalty.weight = -300.0


@configclass
class MagicBotZ1FlatSprintAMPStage2SGatedPriorEnvCfg(MagicBotZ1FlatSprintAMPStage2RYawAuthorityEnvCfg):
    def __post_init__(self):
        super().__post_init__()


@configclass
class MagicBotZ1FlatSprintAMPStage2TAgilityAuthorityEnvCfg(MagicBotZ1FlatSprintAMPStage2SGatedPriorEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_y = (-0.35, 0.35)
        self.commands.ranges.ang_vel_z = (-1.00, 1.00)
        self.commands.straight_command_prob = 0.25
        self.commands.yaw_only_command_prob = 0.50
        self.reference_motion.speed_match_tolerance = 1.05
        self.reward.track_lin_vel_y_exp.weight = 0.45
        self.reward.track_lin_vel_y_exp.params["std"] = 0.36
        self.reward.lateral_speed_progress.weight = 0.28
        self.reward.lateral_speed_progress.params["min_command_abs"] = 0.16
        self.reward.track_ang_vel_z_exp.weight = 2.65
        self.reward.track_ang_vel_z_exp.params["std"] = 0.34
        self.reward.yaw_rate_progress.weight = 0.70
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.30
        self.reward.forward_speed_progress.weight = 0.20


@configclass
class MagicBotZ1FlatSprintAMPStage2UYawSpecialistEnvCfg(MagicBotZ1FlatSprintAMPStage2SGatedPriorEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (2.25, 4.00)
        self.commands.ranges.lin_vel_y = (-0.30, 0.30)
        self.commands.ranges.ang_vel_z = (-0.95, 0.95)
        self.commands.straight_command_prob = 0.20
        self.commands.yaw_only_command_prob = 0.55
        self.reference_motion.min_command_speed = 2.75
        self.reference_motion.max_reference_speed = 4.8
        self.reference_motion.speed_match_tolerance = 0.95
        self.reward.track_lin_vel_xy_exp.weight = 1.70
        self.reward.track_lin_vel_xy_exp.params["std"] = 1.05
        self.reward.track_lin_vel_y_exp.weight = 0.30
        self.reward.track_lin_vel_y_exp.params["std"] = 0.42
        self.reward.lateral_speed_progress.weight = 0.12
        self.reward.lateral_speed_progress.params["min_command_abs"] = 0.16
        self.reward.track_ang_vel_z_exp.weight = 2.85
        self.reward.track_ang_vel_z_exp.params["std"] = 0.32
        self.reward.yaw_rate_progress.weight = 0.95
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.25
        self.reward.forward_speed_progress.weight = 0.16
        self.reward.forward_speed_progress.params["min_command_x"] = 2.50
        self.reward.joint_deviation_hip.weight = -0.10
        self.reward.joint_deviation_arms.weight = -0.16


@configclass
class MagicBotZ1FlatSprintAMPStage2VYawTransferEnvCfg(MagicBotZ1FlatSprintAMPStage2UYawSpecialistEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (3.00, 4.25)
        self.commands.ranges.lin_vel_y = (-0.28, 0.28)
        self.commands.ranges.ang_vel_z = (-0.85, 0.85)
        self.commands.straight_command_prob = 0.35
        self.commands.yaw_only_command_prob = 0.45
        self.reference_motion.min_command_speed = 3.00
        self.reference_motion.max_reference_speed = 5.00
        self.reference_motion.speed_match_tolerance = 0.90
        self.reward.track_lin_vel_xy_exp.weight = 1.95
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.95
        self.reward.track_lin_vel_y_exp.weight = 0.25
        ...
        self.reward.track_ang_vel_z_exp.weight = 2.60
        self.reward.track_ang_vel_z_exp.params["std"] = 0.35
        self.reward.yaw_rate_progress.weight = 0.75
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.25
        self.reward.forward_speed_progress.weight = 0.22
        self.reward.forward_speed_progress.params["min_command_x"] = 3.00
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.18


@configclass
class MagicBotZ1FlatSprintAMPStage2WCommandConditionedEnvCfg(MagicBotZ1FlatSprintAMPStage2SGatedPriorEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_y = (-0.30, 0.30)
        ...
        self.commands.straight_command_prob = 0.35
        self.commands.yaw_only_command_prob = 0.45
        self.reference_motion.command_conditioned_sampling = True
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.80
        self.reference_motion.command_lin_vel_y_scale = 0.28
        self.reference_motion.command_yaw_scale = 0.40
        self.reward.track_lin_vel_y_exp.weight = 0.35
        self.reward.track_lin_vel_y_exp.params["std"] = 0.40
        self.reward.lateral_speed_progress.weight = 0.10
        self.reward.lateral_speed_progress.params["min_command_abs"] = 0.16
        self.reward.track_ang_vel_z_exp.weight = 2.45
        self.reward.track_ang_vel_z_exp.params["std"] = 0.36
        self.reward.yaw_rate_progress.weight = 0.55
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.25
        self.reward.forward_speed_progress.weight = 0.22
        self.reward.forward_speed_progress.params["min_command_x"] = 3.35
...
@configclass
class MagicBotZ1FlatSprintAMPStage2YBaselineBridgeEnvCfg(MagicBotZ1FlatSprintAMPEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (-1.0, 4.00)
        self.commands.ranges.lin_vel_y = (-0.35, 0.35)
        self.commands.ranges.ang_vel_z = (-0.65, 0.65)
        self.commands.rel_standing_envs = 0.25
        self.commands.straight_command_prob = 0.40
        self.commands.yaw_only_command_prob = 0.30
        self.domain_rand.events.push_robot.interval_range_s = (6.0, 10.0)
        self.domain_rand.events.push_robot.params["velocity_range"] = {
            "x": (-1.2, 1.2),
            "y": (-1.2, 1.2),
            "yaw": (-0.8, 0.8),
        ...
        self.reference_motion.min_command_speed = 2.75
        self.reference_motion.max_reference_speed = 4.6
        self.reference_motion.speed_match_tolerance = 1.00
        self.reference_motion.command_conditioned_sampling = True
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.80
        self.reference_motion.command_lin_vel_y_scale = 0.25
        self.reference_motion.command_yaw_scale = 0.35
        self.reward.track_lin_vel_xy_exp.weight = 1.45
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.95
        self.reward.track_lin_vel_y_exp.weight = 0.25
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        self.reward.lateral_speed_progress.weight = 0.06
        self.reward.lateral_speed_progress.params["min_command_abs"] = 0.16
        self.reward.track_ang_vel_z_exp.weight = 1.60
        self.reward.track_ang_vel_z_exp.params["std"] = 0.55
        self.reward.yaw_rate_progress.weight = 0.22
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.25
        self.reward.forward_speed_progress.weight = 0.12
        self.reward.forward_speed_progress.params["min_command_x"] = 3.00
        self.reward.head_shoulder_contact_termination_penalty.weight = -220.0
        self.reward.ang_vel_xy_l2.weight = -0.06
        self.reward.body_orientation_l2.weight = -1.8
        self.reward.flat_orientation_l2.weight = -0.9
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.12


@configclass
class MagicBotZ1FlatSprintAMPStage2ZHighStartEnvCfg(MagicBotZ1FlatSprintAMPEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (2.0, 3.50)
        self.commands.ranges.lin_vel_y = (-0.25, 0.25)
        self.commands.ranges.ang_vel_z = (-0.45, 0.45)
        self.commands.rel_standing_envs = 0.05
        self.commands.straight_command_prob = 0.55
        self.commands.yaw_only_command_prob = 0.25
        self.commands.command_slew_rate = (0.0, 0.0, 0.0)
        ...
        self.reference_motion.min_command_speed = 2.50
        self.reference_motion.max_reference_speed = 4.20
        self.reference_motion.speed_match_tolerance = 0.80
        self.reference_motion.command_conditioned_sampling = True
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.80
        self.reference_motion.command_lin_vel_y_scale = 0.22
        self.reference_motion.command_yaw_scale = 0.30
        self.reward.track_lin_vel_xy_exp.weight = 1.80
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.80
        self.reward.track_lin_vel_y_exp.weight = 0.18
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        self.reward.track_ang_vel_z_exp.weight = 1.35
        self.reward.track_ang_vel_z_exp.params["std"] = 0.55
        self.reward.forward_speed_progress.weight = 0.25
        self.reward.forward_speed_progress.params["min_command_x"] = 2.50
        self.reward.yaw_rate_progress.weight = 0.12
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.20
        self.reward.head_shoulder_contact_termination_penalty.weight = -240.0
        self.reward.ang_vel_xy_l2.weight = -0.07
        self.reward.body_orientation_l2.weight = -1.9
        self.reward.flat_orientation_l2.weight = -0.95
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.12


@configclass
class MagicBotZ1FlatSprintAMPStage2AAStage1CExtendEnvCfg(MagicBotZ1FlatSprintAMPStage1CEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (-1.0, 4.10)
        self.commands.ranges.lin_vel_y = (-0.25, 0.25)
        self.commands.ranges.ang_vel_z = (-0.55, 0.55)
        self.commands.rel_standing_envs = 0.20
        self.commands.straight_command_prob = 0.45
        self.commands.yaw_only_command_prob = 0.25
        self.domain_rand.events.push_robot.interval_range_s = (8.0, 12.0)
        self.domain_rand.events.push_robot.params["velocity_range"] = {
        ...
        self.reference_motion.min_command_speed = 2.50
        self.reference_motion.max_reference_speed = 4.80
        self.reference_motion.speed_match_tolerance = 0.90
        self.reference_motion.command_conditioned_sampling = True
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.80
        self.reference_motion.command_lin_vel_y_scale = 0.22
        self.reference_motion.command_yaw_scale = 0.32
        self.reward.track_lin_vel_xy_exp.weight = 1.60
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.90
        self.reward.track_lin_vel_y_exp.weight = 0.22
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        self.reward.track_ang_vel_z_exp.weight = 1.55
        self.reward.track_ang_vel_z_exp.params["std"] = 0.50
        self.reward.forward_speed_progress.weight = 0.18
        self.reward.forward_speed_progress.params["min_command_x"] = 2.75
        self.reward.yaw_rate_progress.weight = 0.18
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.22
        self.reward.head_shoulder_contact_termination_penalty.weight = -240.0
        self.reward.ang_vel_xy_l2.weight = -0.06
        self.reward.body_orientation_l2.weight = -1.9
        self.reward.flat_orientation_l2.weight = -0.95
        self.reward.energy.weight = -8.0e-4
        self.reward.action_rate_l2.weight = -8.5e-3
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.14


@configclass
class MagicBotZ1FlatSprintAMPStage2ABHighTransitionEnvCfg(MagicBotZ1FlatSprintAMPStage2AAStage1CExtendEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (2.75, 4.05)
        self.commands.ranges.lin_vel_y = (-0.20, 0.20)
        self.commands.ranges.ang_vel_z = (-0.45, 0.45)
        self.commands.rel_standing_envs = 0.10
        self.commands.straight_command_prob = 0.55
        self.commands.yaw_only_command_prob = 0.20
        self.domain_rand.events.push_robot.interval_range_s = (8.0, 12.0)
        self.domain_rand.events.push_robot.params["velocity_range"] = {
            "x": (-0.9, 0.9),
            "y": (-0.9, 0.9),
        ...
        self.reference_motion.min_command_speed = 2.75
        self.reference_motion.max_reference_speed = 4.50
        self.reference_motion.speed_match_tolerance = 0.75
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.78
        self.reference_motion.command_lin_vel_y_scale = 0.18
        self.reference_motion.command_yaw_scale = 0.26
        self.reward.track_lin_vel_xy_exp.weight = 1.85
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.80
        self.reward.track_lin_vel_y_exp.weight = 0.18
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        ...
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.22
        self.reward.head_shoulder_contact_termination_penalty.weight = -300.0
        self.reward.ang_vel_xy_l2.weight = -0.09
        self.reward.body_orientation_l2.weight = -2.05
        self.reward.flat_orientation_l2.weight = -1.05
        self.reward.energy.weight = -7.0e-4
        self.reward.action_rate_l2.weight = -7.5e-3
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.14
...
@configclass
class MagicBotZ1FlatSprintAMPStage2ACMixedRetentionEnvCfg(MagicBotZ1FlatSprintAMPStage2AAStage1CExtendEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.commands.ranges.lin_vel_x = (-0.50, 4.05)
        self.commands.ranges.lin_vel_y = (-0.22, 0.22)
        self.commands.ranges.ang_vel_z = (-0.50, 0.50)
        self.commands.rel_standing_envs = 0.24
        self.commands.straight_command_prob = 0.55
        self.commands.yaw_only_command_prob = 0.20
        self.domain_rand.events.push_robot.interval_range_s = (7.0, 11.0)
        self.domain_rand.events.push_robot.params["velocity_range"] = {
            "x": (-1.0, 1.0),
            "y": (-1.0, 1.0),
            "yaw": (-0.6, 0.6),
        ...
        self.reference_motion.min_command_speed = 2.50
        self.reference_motion.max_reference_speed = 4.65
        self.reference_motion.speed_match_tolerance = 0.80
        self.reference_motion.command_sample_candidates = 64
        self.reference_motion.speed_sample_jitter_frames = 256
        self.reference_motion.command_lin_vel_x_scale = 0.78
        self.reference_motion.command_lin_vel_y_scale = 0.20
        self.reference_motion.command_yaw_scale = 0.28
        self.reward.track_lin_vel_xy_exp.weight = 1.75
        self.reward.track_lin_vel_xy_exp.params["std"] = 0.85
        self.reward.track_lin_vel_y_exp.weight = 0.20
        self.reward.track_lin_vel_y_exp.params["std"] = 0.45
        self.reward.track_ang_vel_z_exp.weight = 1.45
        self.reward.track_ang_vel_z_exp.params["std"] = 0.52
        self.reward.forward_speed_progress.weight = 0.20
        self.reward.forward_speed_progress.params["min_command_x"] = 3.05
        self.reward.yaw_rate_progress.weight = 0.14
        self.reward.yaw_rate_progress.params["min_command_abs"] = 0.22
        self.reward.head_shoulder_contact_termination_penalty.weight = -280.0
        self.reward.ang_vel_xy_l2.weight = -0.075
        self.reward.body_orientation_l2.weight = -1.98
        self.reward.flat_orientation_l2.weight = -1.00
        self.reward.energy.weight = -7.5e-4
        self.reward.action_rate_l2.weight = -8.0e-3
        self.reward.joint_deviation_hip.weight = -0.12
        self.reward.joint_deviation_arms.weight = -0.14
...
@configclass
class MagicBotZ1FlatSprintAMPStage2NAgilityMixAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2n_agilitymix_cmdx3p35_4p5_"
        "cmdy0p35_yaw0p65_trackxy1p95_tracky0p55_trackyaw1p85_lr2e-5"
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2PMixedCommandAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2p_mixedcommand_cmdx3p35_4p55_"
        "cmdy0p35_yaw0p65_straight0p45_tracky0p45_trackyaw1p75_lr1p5e-5"
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2QYawFocusAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2q_yawfocus_cmdx3p35_4p55_"
        "cmdy0p30_yaw0p75_straight0p40_yawonly0p35_trackyaw2p10_lr1e-5"
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2RYawAuthorityAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2r_yawauthority_cmdx3p35_4p55_"
        "cmdy0p25_yaw0p85_straight0p35_yawonly0p45_yawprog0p45_lr8e-6"
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2SGatedPriorAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2s_gatedprior_cmdx3p35_4p55_"
        "cmdy0p25_yaw0p85_straight0p35_yawonly0p45_ampgate_y0p12_yaw0p20_lr8e-6"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_coef = 0.08
        self.motion_prior.reward_min_command_speed = 3.35
        self.motion_prior.reward_max_command_y_abs = 0.12
        self.motion_prior.reward_command_y_gate_width = 0.13
        self.motion_prior.reward_max_command_yaw_abs = 0.20
        self.motion_prior.reward_command_yaw_gate_width = 0.25
        self.save_interval = 25


@configclass
class MagicBotZ1FlatSprintAMPStage2TAgilityAuthorityAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2t_agilityauthority_cmdx3p35_4p55_"
        "cmdy0p35_yaw1p00_straight0p25_yawonly0p50_yprog0p28_yawprog0p70_"
        "ampgate_y0p18_yaw0p35_lr6e-6"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_coef = 0.08
        self.motion_prior.reward_min_command_speed = 3.35
        self.motion_prior.reward_max_command_y_abs = 0.18
        self.motion_prior.reward_command_y_gate_width = 0.20
        self.motion_prior.reward_max_command_yaw_abs = 0.35
        self.motion_prior.reward_command_yaw_gate_width = 0.35
        self.save_interval = 25


@configclass
class MagicBotZ1FlatSprintAMPStage2UYawSpecialistAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2u_yawspecialist_cmdx2p25_4p0_"
        "cmdy0p30_yaw0p95_straight0p20_yawonly0p55_yawprog0p95_"
        "ampgate_y0p12_yaw0p20_lr5e-6"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_coef = 0.08
        self.motion_prior.reward_min_command_speed = 2.75
        self.motion_prior.reward_max_command_y_abs = 0.12
        self.motion_prior.reward_command_y_gate_width = 0.13
        self.motion_prior.reward_max_command_yaw_abs = 0.20
        self.motion_prior.reward_command_yaw_gate_width = 0.25
...
@configclass
class MagicBotZ1FlatSprintAMPStage2VYawTransferAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2v_yawtransfer_cmdx3p0_4p25_"
        "cmdy0p28_yaw0p85_straight0p35_yawonly0p45_yawprog0p75_"
        "ampgate_y0p12_yaw0p20_lr4e-6"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_coef = 0.08
        self.motion_prior.reward_min_command_speed = 3.00
        self.motion_prior.reward_max_command_y_abs = 0.12
        self.motion_prior.reward_command_y_gate_width = 0.13
        self.motion_prior.reward_max_command_yaw_abs = 0.20
        self.motion_prior.reward_command_yaw_gate_width = 0.25
...
@configclass
class MagicBotZ1FlatSprintAMPStage2WCommandConditionedAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2w_cmdcond_fromstage2s_"
        "cmdx3p35_4p55_cmdy0p30_yaw0p90_refcmd64_y0p28_yaw0p40_"
        "ampallturn_lr6e-6"
    )
...
@configclass
class MagicBotZ1FlatSprintAMPStage2YBaselineBridgeAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2y_baselinebridge_from23000_"
        "cmdx-1p0_4p0_cmdy0p35_yaw0p65_push1p2_6to10s_"
        "ampgate3p0_lr2e-5"
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.algorithm.learning_rate = 2.0e-5
        self.motion_prior.reward_coef = 0.05
        self.motion_prior.reward_min_command_speed = 3.00
        self.motion_prior.reward_max_command_y_abs = 0.25
        self.motion_prior.reward_command_y_gate_width = 0.15
        self.motion_prior.reward_max_command_yaw_abs = 0.45
        self.motion_prior.reward_command_yaw_gate_width = 0.20
        self.motion_prior.expert_command_conditioning = True
        self.motion_prior.expert_command_dim = 3
        self.save_interval = 25
...
@configclass
class MagicBotZ1FlatSprintAMPStage2ZHighStartAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2z_highstart_from23000_"
        "cmdx2p0_3p5_cmdy0p25_yaw0p45_instantcmd_"
        "ampgate2p75_fixedlr3e-5"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_coef = 0.04
        self.motion_prior.reward_min_command_speed = 2.75
        self.motion_prior.reward_max_command_y_abs = 0.20
        self.motion_prior.reward_command_y_gate_width = 0.15
        self.motion_prior.reward_max_command_yaw_abs = 0.35
        self.motion_prior.reward_command_yaw_gate_width = 0.20
        self.motion_prior.expert_command_conditioning = True
...
@configclass
class MagicBotZ1FlatSprintAMPStage2AAStage1CExtendAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2aa_stage1c_extend_"
        "cmdx-1p0_4p1_cmdy0p25_yaw0p55_push1p0_"
        "ampgate2p75_fixedlr5e-5"
    )
    ...
    def __post_init__(self):
        ...
        self.algorithm.learning_rate = 5.0e-5
        self.algorithm.schedule = "fixed"
        self.motion_prior.reward_coef = 0.06
        self.motion_prior.reward_min_command_speed = 2.75
        self.motion_prior.reward_max_command_y_abs = 0.22
        self.motion_prior.reward_command_y_gate_width = 0.15
        self.motion_prior.reward_max_command_yaw_abs = 0.45
        self.motion_prior.reward_command_yaw_gate_width = 0.20
        self.motion_prior.expert_command_conditioning = True
...
@configclass
class MagicBotZ1FlatSprintAMPStage2ABHighTransitionAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2ab_hightransition_"
        "cmdx2p75_4p05_cmdy0p20_yaw0p45_headguard_"
        "ampgate3p0_fixedlr3e-5"
    )
    ...
    def __post_init__(self):
        ...
        self.motion_prior.reward_min_command_speed = 3.00
        self.motion_prior.reward_max_command_y_abs = 0.18
        self.motion_prior.reward_command_y_gate_width = 0.12
        self.motion_prior.reward_max_command_yaw_abs = 0.35
        self.motion_prior.reward_command_yaw_gate_width = 0.18
        self.motion_prior.expert_command_conditioning = True
        self.motion_prior.expert_command_dim = 3
        self.save_interval = 25
...
@configclass
class MagicBotZ1FlatSprintAMPStage2ACMixedRetentionAgentCfg(MagicBotZ1FlatSprintAMPAgentCfg):
    run_name: str = (
        "z1_sprint_amp_stage2ac_mixedretention_"
        "cmdx-0p5_4p05_stand0p24_push1p0_"
        "ampgate3p0_fixedlr3e-5"
    )
    ...
    def __post_init__(self):
        ...
        self.algorithm.learning_rate = 3.0e-5
        self.algorithm.schedule = "fixed"
        self.motion_prior.reward_coef = 0.055
        self.motion_prior.reward_min_command_speed = 3.00
        self.motion_prior.reward_max_command_y_abs = 0.20
        self.motion_prior.reward_command_y_gate_width = 0.14
        self.motion_prior.reward_max_command_yaw_abs = 0.40
        self.motion_prior.reward_command_yaw_gate_width = 0.18
        self.motion_prior.expert_command_conditioning = True
        self.motion_prior.expert_command_dim = 3
        self.save_interval = 25
